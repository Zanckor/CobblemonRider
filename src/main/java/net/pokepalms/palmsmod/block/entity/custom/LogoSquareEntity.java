...
public class LogoSquareEntity extends BlockEntity implements GeoBlockEntity {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    public LogoSquareEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.LOGO_SQUARE_ENTITY, pos, state);
    }
